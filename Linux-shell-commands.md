1. **host name**  ---------------->   To check machine name
2. **pwd**  ---------------->   Present Working directly
3. **$**  ---------------->   Local User
4. **lscpu**  ---------------->   To check cpu
5. **lscpu|less**  ----------------> scroll
6. **Press Q**  ----------------> For Quit
...
18. **ctrl +d**  ----------------> Exit
19. **which** --------------> check location 

20. **who** ---------------> check all user activite

21. **uptime** ------------> check uptime

22. **id** ----------------> check all user
